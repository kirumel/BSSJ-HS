      ...
      <div className="right-left-margin home-layout">
        ...
        <ul>
          ...
          <li>
            ...
            독립적으로 정보를 사용할 수 없으며 본 개인정보처리방침에 명시된
            규칙을 준수하는 서비스 제공자와 공유할 때.
          </li>
        </ul>
        ...
        <p>
          서비스 제공자는 사용자가 애플리케이션을 사용하는 동안과 그 이후
          합리적인 기간 동안 사용자 제공 데이터를 보존할 것입니다.
          애플리케이션을 통해 제공한 사용자 제공 데이터를 삭제하고 싶으시면,{" "}
        ...
        <p>
          ...
          있습니다. 서비스 제공자는 처리 및 유지 관리하는 정보 보호를 위해
          물리적, 전자적 및 절차적 보호 조치를 제공합니다.
        </p>
        ...
        <strong>문의하기</strong>
        <p>
          애플리케이션 사용 중 개인정보 보호에 관해 질문이 있거나 서비스
          제공자의 정책에 대해 궁금한 점이 있으시면,{" "}
          <a href="mailto:admin@altisto.me">admin@altisto.me</a>로 연락해 주시기
          바랍니다.
        </p>
        ...
        <div>
          ...
          <p>
            ...
            "Application") for mobile devices created by Altisto (hereby
          ...
          <p>
            ...
            password, and profileImage. The information that the Service
            Provider requests will be retained and used as described in this
            privacy policy.
          </p>
          ...
          <p>
            ...
            available as part of your mobile device or via the mobile
          ...
          <p>
            ...
            personal information, they will immediately delete this from their
          ...
          <p>
            ...
            electronic, and procedural safeguards to protect information that
