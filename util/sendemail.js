...
export default async function sendVerificationEmail(email, expires, token) {
  try {
    await transporter.sendMail({
      ...
      <div style="margin-top: 20px; "><a href="http://altisto.me/verify-email?email=${email}&token=${token}" style="text-decoration: none;"><button style="border: none; background-color: rgb(113, 128, 172); color: white; padding: 10px; border-radius: 10px;">인증하기</button></a></div>
